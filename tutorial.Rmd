...
Install the package provided in this folder following the instruction on `README.md` or running
...
We generate an artificial network via `igraph`, and convert it into ad edge-list. This is the format which is naturally used by `svilf`
